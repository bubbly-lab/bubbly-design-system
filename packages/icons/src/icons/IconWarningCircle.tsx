...
const IconWarningCircle: ForwardRefExoticComponent<
  IconProps & RefAttributes<SVGSVGElement>
> = forwardRef<SVGSVGElement, IconProps>(function IconWarningCircle(
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M12 14.7C12.552 14.701 13 15.148 13 15.7 13 16.253 12.552 16.7 12 16.7 11.448 16.7 11.001 16.253 11 15.7 11 15.148 11.448 14.7 12 14.7ZM12 7C12.387 7 12.7 7.371 12.7 7.829V12.571C12.7 13.029 12.387 13.4 12 13.4 11.614 13.4 11.3 13.029 11.3 12.571V7.829C11.3 7.371 11.614 7 12 7Z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
