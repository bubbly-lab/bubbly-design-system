...
const IconLock: ForwardRefExoticComponent<IconProps & RefAttributes<SVGSVGElement>> = forwardRef<SVGSVGElement, IconProps>(
  function IconLock({ size = '1em', filled = false, color = 'currentColor', title, ...props }, ref) {
    void color;
