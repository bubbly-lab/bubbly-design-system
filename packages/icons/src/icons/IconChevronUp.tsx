...
const IconChevronUp: ForwardRefExoticComponent<IconProps & RefAttributes<SVGSVGElement>> = forwardRef<SVGSVGElement, IconProps>(
  function IconChevronUp({ size = '1em', filled = false, color = 'currentColor', title, ...props }, ref) {
    void color;
