...
const IconMail: ForwardRefExoticComponent<
  IconProps & RefAttributes<SVGSVGElement>
> = forwardRef<SVGSVGElement, IconProps>(function IconMail(
    ...
    >
      ...
      {filled ? (
        <>
          <path
            fill="currentColor"
            d="M20.7004 16.0002C20.7003 17.4913 19.4913 18.7003 18.0002 18.7004H6.00024C4.50914 18.7004 3.30015 17.4913 3.30005 16.0002V8.43286L11.6868 12.6262C11.8837 12.7247 12.1158 12.7246 12.3127 12.6262L20.7004 8.43188V16.0002Z"
          />
          <path
            fill="currentColor"
            d="M18.0002 5.30005C19.126 5.30013 20.09 5.98964 20.4954 6.96899L11.9993 11.218L3.50415 6.96997C3.90916 5.98994 4.87399 5.30005 6.00024 5.30005H18.0002Z"
          />
        </>
      ) : (
        <path
