...
const IconPlus: ForwardRefExoticComponent<IconProps & RefAttributes<SVGSVGElement>> = forwardRef<SVGSVGElement, IconProps>(
  function IconPlus({ size = '1em', filled = false, color = 'currentColor', title, ...props }, ref) {
    void color;
