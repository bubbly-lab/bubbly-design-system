...
const IconLoading: ForwardRefExoticComponent<IconProps & RefAttributes<SVGSVGElement>> = forwardRef<SVGSVGElement, IconProps>(
  function IconLoading({ size = '1em', filled = false, color = 'currentColor', title, ...props }, ref) {
    void color;
