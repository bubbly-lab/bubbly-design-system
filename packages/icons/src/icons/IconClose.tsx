...
const IconClose: ForwardRefExoticComponent<IconProps & RefAttributes<SVGSVGElement>> = forwardRef<SVGSVGElement, IconProps>(
  function IconClose({ size = '1em', filled = false, color = 'currentColor', title, ...props }, ref) {
    void color;
