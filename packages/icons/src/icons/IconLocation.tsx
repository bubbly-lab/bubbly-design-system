...
const IconLocation: ForwardRefExoticComponent<IconProps & RefAttributes<SVGSVGElement>> = forwardRef<SVGSVGElement, IconProps>(
  function IconLocation({ size = '1em', filled = false, color = 'currentColor', title, ...props }, ref) {
    void color;
